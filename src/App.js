...
const contract = new web3.eth.Contract(Contract_ABI, "0x524209929eD34eAFd856d29f5C2E3Bf2956c6061");
...
function App() {
  ...
  const DeployContract = async () => {
    ...
    if (account === '') {
      ...
      new web3.eth.Contract(Contract_ABI).deploy({
        data: Contract_ByteCode.object,
        arguments: [TokenName, TokenSymbol, TokenAmount, DueDateAmount, DueDate]
      }).send({
        from: account
      })
  ...
  const RemoveFromBlackList = async () => {
    ...
    let balckAddress = document.getElementById("RemoveFromBlackListInput").value;
  ...
  return (
    <>
      ...
      <div className='OneColumnContainer'>
        <div className="item">
          <button onClick={ConnetMetmask} class="button MetaMaskBtn"> Connect MetaMask </button>
          <input id="MetaMaskAccount" className='input' />
        </div>
      </div>
      ...
      <div className='container BottomMargin'>
        ...
        <div className="item">
          ...
          <div>
            <input id="TOKENNAME" className='input' placeholder='Enter Token Name' /><br />
            <input id="TOKENSYMBOL" className='input' placeholder='Enter Token Symbol' /><br />
            <input id="TOKENAMOUNT" className='input' placeholder='Enter Token Amount' /><br />
            <input id="DUEDATEAMOUNT" className='input' placeholder='Enter Token Due Date Amount' /><br />
            <input id="DUEDATE" className='input' placeholder='Enter Token Due Date' />
            <button onClick={DeployContract} className="button TransactButton"> Deploy Contract </button>
          </div>

          <div>
            <input id="BlackListInput" className='input' placeholder='Enter Address to Block' /><br />
            <button onClick={AddToBlackList} className="button TransactButton"> Add Black List </button>
          </div>

          <div>
            <input id="RemoveFromBlackListInput" className='input' placeholder='Enter Address to Block' /><br />
            <button onClick={RemoveFromBlackList} className="button TransactButton"> Remove From Black List </button>
          </div>

          <div>
            <input type="radio" id="trueRadio" name="checkRadio" value="true" /><i id="trueRadioText">True</i>
            <input type="radio" id="falseRadio" name="checkRadio" value="false" /><i id="falseRadioText">Fasle</i><br />
            <button onClick={EnableBlockAllTrans} className="button TransactButton"> Block All Transactions </button><br />
          </div>

          <div>
            <input id="MintDailyInput" className='input' placeholder='Enter Token number' /><br />
            <button onClick={MintDaily} className="button TransactButton"> Mint Daily </button>
          </div>

          <div>
            <input id="ApproveSpender" className='input' placeholder='Spender' /><br />
            <input id="ApproveAmount" className='input' placeholder='Amount' /><br />
            <button onClick={Approve} className="button TransactButton"> Approve </button>
          </div>

          <div>
            <input id="DecreaseAllowanceSpender" className='input' placeholder='Spender' /><br />
            <input id="DecreaseAllowanceAmount" className='input' placeholder='Amount' /><br />
            <button onClick={DecreaseAllowance} className="button TransactButton"> Decrease Allowance </button>
          </div>

          <div>
            <input id="IncreaseAllowanceSpender" className='input' placeholder='Spender' /><br />
            <input id="IncreaseAllowanceAmount" className='input' placeholder='Amount' /><br />
            <button onClick={IncreaseAllowance} className="button TransactButton"> Increase Allowance </button>
          </div>

          <div>
            <input id="TransferReceiverAddress" className='input' placeholder='Receiver Address' /><br />
            <input id="TransferAmount" className='input' placeholder='Amount' /><br />
            <button onClick={Transfer} className="button TransactButton"> Transfer </button>
          </div>

          <div>
            <input id="TransferFromAddress" className='input' placeholder='From' /><br />
            <input id="TransferToAddress" className='input' placeholder='To' /><br />
            <input id="TransferFromAmount" className='input' placeholder='Amount' /><br />
            <button onClick={TransferFrom} className="button TransactButton"> Transfer From </button>
          </div>
        ...
        <div className="item">
          ...
          <div>
            <input id="checkBlackAddress" className='input' placeholder='address' /><br />
            <button onClick={CheckBlackAddress} className="button"> Check Address Is Black </button>
            <input id="ResultCheckBlackAddress" className='HiddenInnput' />
          </div>

          <div>
            <input id="BalanceOf" className='input' placeholder='address' /><br />
            <button onClick={BalanceOf} className="button"> Balance Of </button>
            <input id="ShowBalance" className='HiddenInnput' />
          </div>

          <div>
            <input id="allowanceOwner" className='input' placeholder='owner address' /><br />
            <input id="allowanceSpender" className='input' placeholder='spender address' /><br />
            <button onClick={Allowance} className="button"> Allowance </button>
            <input id="ShowAllowance" className='HiddenInnput' />
          </div>

          <div>
            <button onClick={ShowTokenNmae} className="button"> Show Token name </button>
            <input id="NameInput" className='HiddenInnput' />
          </div>

          <div>
            <button onClick={ShowTokenSymbol} className="button"> Show Token Symbol </button>
            <input id="TokenSymbol" className='HiddenInnput' />
          </div>

          <div>
            <button onClick={BlockAllTransValue} className="button"> Block All Trans Value </button>
            <input id="BlockAllTransValue" className='HiddenInnput' />
          </div>

          <div>
            <button onClick={ShowBlackList} className="button"> Show Black List </button><br />
            <ul id="BlackList">
            </ul>
          </div>

          <div>
            <button onClick={ContractOwner} className="button"> Contract Owner </button>
            <input id="ContractOwner" className='HiddenInnput' />
          </div>

          <div>
            <button onClick={Desimals} className="button"> Decimals </button>
            <input id="Decimal" className='HiddenInnput' />
          </div>

          <div>
            <button onClick={DueDate} className="button"> Due Date </button>
            <input id="DueDate" className='HiddenInnput' />
          </div>

          <div>
            <button onClick={DueDateAmount} className="button"> Due Date Amount </button>
            <input id="DueDateAmount" className='HiddenInnput' />
          </div>

          <div>
            <button onClick={TotalSupply} className="button"> Total Supply </button>
